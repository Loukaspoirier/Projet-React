...
export default function UpdateLogFormAdmin(props) { // This component is used to update a log for an admin
  ...
  const handleSubmit = (e) => { // This function is used to submit the form
    e.preventDefault();
  ...
  useEffect(() => { // This effect hook is used to fetch data when the component mounts
    if (props.id) {
      fetchData();
    }
  }, []);
  ...
  return (
    <div>
      ...
      ) : ( // If the data is loaded, render the form
        <Row>
          ...
          <div className="col-md-4">
            <Form onSubmit={handleSubmit} className="rounded-4 border-hexa p-3">
              ...
              {(() => { // This IF is used to check the form data and render the appropriate button
                if ( // If the form data is not valid, render a disabled button
                ...
                } else if (formData.password !== formData.password_confirm) { // If the passwords are not the same, render a disabled button
                  return (
                    <>
                      <div className="mt-3 d-flex justify-content-center">
                        <p className="text-danger">
                ...
                } else if (!formData.email.endsWith("@ecole-hexagone.com")) { // If the email does not end with '@ecole-hexagone.com'
                  return (
                    <>
                      <div className="mt-3 d-flex justify-content-center">
                        <p className="text-danger">
                ...
                } else { // If the form data is valid, render a button
                  return (
                    <>
                      <div className="d-flex justify-content-center">
