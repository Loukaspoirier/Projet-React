...
export default function PrivateRouteAdmin() { // This is a private route component for admin users
  ...
  // If the user is logged in but not an admin, render the NotFoundRoles component
  if (userRole !== "ROLE_ADMIN") {
    return <NotFoundRoles />;
  }

  // If the user is an admin, render the children of this route
  return <Outlet />;
}
