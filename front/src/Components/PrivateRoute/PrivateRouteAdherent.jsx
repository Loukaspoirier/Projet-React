...
export default function PrivateRouteAdherent() { // This is a private route component for adherent users
  ...
  // If the user is logged in but is a visitor, render the NotFoundRoles component
  if (userRole === "ROLE_VISITOR") { // If the user is logged in but is a visitor, render the NotFoundRoles component
    return <NotFoundRoles />;
  }

  // If the user is an adherent, render the children of this route
  return <Outlet />;
}
