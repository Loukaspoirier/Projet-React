...
export default function PrivateRouteVisitor() { // This is a private route component for visitor users
  ...
  // If the user is logged in, render the children of this route
  return <Outlet />;
}
