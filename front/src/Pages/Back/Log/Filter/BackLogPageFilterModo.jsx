...
import ReadAllLogFilterModo from "../../../../Components/Back/Log/Filter/ReadAllLogFilterModo";
import "../../../../index.css";

export default function BackLogPageFilterModo() { // This component is the log page for the admin interface with a filter for the role "modo"
