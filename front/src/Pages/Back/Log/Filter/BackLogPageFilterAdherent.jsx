...
import ReadAllLogFilterAdherent from "../../../../Components/Back/Log/Filter/ReadAllLogFilterAdherent";
import "../../../../index.css";

export default function BackLogPageFilterAdherent() { // This component is the log page for the admin interface with a filter for the role "adherent"
