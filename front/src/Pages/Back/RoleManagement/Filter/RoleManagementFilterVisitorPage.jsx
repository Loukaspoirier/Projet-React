...
import RoleManagementFilterVisitor from "../../../../Components/Back/RoleManagement/Filter/RoleManagementFilterVisitor";
import BackNavBar from "../../../../Components/Back/BackNavBar";

export default function RoleManagementFilterVisitorPage() { // This component is the role management page for the admin interface with a filter for the role "visitor"
