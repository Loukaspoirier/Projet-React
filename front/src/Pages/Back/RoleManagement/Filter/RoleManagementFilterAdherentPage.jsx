...
import RoleManagementFilterAdherent from "../../../../Components/Back/RoleManagement/Filter/RoleManagementFilterAdherent";
import BackNavBar from "../../../../Components/Back/BackNavBar";

export default function RoleManagementFilterAdherentPage() { // This component is the role management page for the admin interface with a filter for the role "adherent"
