 ...
 */
class getMessageTicketRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MessageTicketRepository' shared autowired service.
     *
     * @return \App\Repository\MessageTicketRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MessageTicketRepository.php';

        return $container->privates['App\\Repository\\MessageTicketRepository'] = new \App\Repository\MessageTicketRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
