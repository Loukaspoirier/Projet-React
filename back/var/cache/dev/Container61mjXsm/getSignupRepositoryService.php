 ...
 */
class getSignupRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SignupRepository' shared autowired service.
     *
     * @return \App\Repository\SignupRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SignupRepository.php';

        return $container->privates['App\\Repository\\SignupRepository'] = new \App\Repository\SignupRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
