 ...
 */
final class Version20240209130609 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE signup (id INT AUTO_INCREMENT NOT NULL, userlastname VARCHAR(70) NOT NULL, userfirstname VARCHAR(70) NOT NULL, email VARCHAR(70) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_4EA31EEFE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
